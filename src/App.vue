...
<template>
    ...
    <!-- Container Look-Alike Section -->
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-12">
          <div class="card" style="width: 25%;">
            <!-- Use an <a> tag with href="javascript:void(0)" -->
            <a href="javascript:void(0)" @click="onCardClick" style="text-decoration: none;">
              <div class="card-body">
                <h5 class="card-title text-primary">Task List</h5>
                <p class="card-text text-primary">This is a TaskList.</p>
              </div>
            </a>
          </div>
        </div>
